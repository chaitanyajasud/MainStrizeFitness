...
export default function Banner() {
  return (
    <Main>
      ...
      <Container>
        <RightBox>
          <WithBarTitle title="WITH StrizeFitness" />
          <H1>Build Perfect body shape for good and healthy life. with StrizeFitness</H1>
          <Button animation="fadeInLeft">Take Subscription</Button>
        </RightBox>
        <LeftBox>
          <Circle>
            <CircleButton>
